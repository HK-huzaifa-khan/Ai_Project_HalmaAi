...
class Board:
    ...
    def draw_board(self, win):
        ...
        # Fill in white starting zone with grey
        for square in WHITE_START:
            pygame.draw.rect(win, (128, 128, 128), (  # Grey color for White starting zone
                square[0] * SQUARE_SIZE,
                square[1] * SQUARE_SIZE,
                SQUARE_SIZE,
                SQUARE_SIZE
        ...
        # Fill in white starting zone dark spaces with darker grey
        for square in WHITE_DARK:
            pygame.draw.rect(win, (96, 96, 96), (  # Darker grey for dark squares
                square[0] * SQUARE_SIZE,
                square[1] * SQUARE_SIZE,
                SQUARE_SIZE,
                SQUARE_SIZE
